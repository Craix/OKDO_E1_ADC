...
static void ADC0_init(void) {
  ...
  LPADC_SetConvCommandConfig(ADC0_PERIPHERAL, ADC0_FIRST, &ADC0_commandsConfig[0]);
  /* Configure trigger 5. */
  LPADC_SetConvTriggerConfig(ADC0_PERIPHERAL, ADC0_FIRST_, &ADC0_triggersConfig[0]);
