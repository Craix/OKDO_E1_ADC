...
/*! @name PIO0_13 (number 71), OLED
  @{ */
#define OLDE_SDA_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLDE_SDA_PIN 13U                   /*!<@brief PORT pin number */
#define OLDE_SDA_PIN_MASK (1U << 13U)      /*!<@brief PORT pin mask */
                                           /* @} */

/*! @name PIO0_14 (number 72), OLED
  @{ */
#define OLDE_SCL_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define OLDE_SCL_PIN 14U                   /*!<@brief PORT pin number */
#define OLDE_SCL_PIN_MASK (1U << 14U)      /*!<@brief PORT pin mask */
                                           /* @} */
 ...
 *
 */
void OLDE(void); /* Function assigned for the Cortex-M33 (Core #0) */
...
/*! @name PIO0_23 (number 20), ADC
  @{ */
#define ADC_P_GPIO GPIO                 /*!<@brief GPIO device name: GPIO */
#define ADC_P_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ADC_P_PIN 23U                   /*!<@brief PORT pin number */
#define ADC_P_PIN_MASK (1U << 23U)      /*!<@brief PORT pin mask */
                                        /* @} */

/*! @name PIO0_16 (number 14), ADC
  @{ */
#define ADC_N_GPIO GPIO                 /*!<@brief GPIO device name: GPIO */
#define ADC_N_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define ADC_N_PIN 16U                   /*!<@brief PORT pin number */
#define ADC_N_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                        /* @} */
